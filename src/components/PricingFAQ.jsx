...
/**
 * Pricing FAQ. Every number is pulled from the canonical catalog rather than
 * typed into the copy, so an answer here cannot contradict the plan cards
 * above it — which is exactly how the old page ended up advertising credit
 * allowances no endpoint enforced.
 *
 * Nothing here discloses provider cost or the platform margin; see
 * base44/PRICING_INTERNAL.md for why that line matters.
 */
